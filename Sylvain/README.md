...
- Permet de brancher d'autres formats (JSON, Excel...) sans modifier le code existant (OCP)

#### 1.2- IAfficheur
- Définition du contrat d'affichage des statistiques
- Déclaration de la méthode afficher(statistiques)
- Séparation en interface distincte de IExporteur (ISP)
...
- Contient 9 étudiants avec 5 colonnes : Nom, Age, Note, Salaire, Heures
